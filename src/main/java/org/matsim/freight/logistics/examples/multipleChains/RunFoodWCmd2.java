 ...
 *
 */
public class RunFoodWCmd2 {

    static Logger log = LogManager.getLogger(RunFoodWCmd2.class);
  ...
  public static void main(String[] args) throws ExecutionException, InterruptedException, CommandLine.ConfigurationException {
    ...
    public static void run(String[] args) throws ExecutionException, InterruptedException, CommandLine.ConfigurationException {
        ...
        final String carriersFile = cmd.getOption("carriersFile").orElse(pathToInput + "CarrierLEH_v2_withFleet_Shipment_OneTW_PickupTime_ICEV.xml");
        ...
        for (Carrier carrier : carriers.getCarriers().values()) {
            if  (carrier == null) {
                throw new RuntimeException("Carrier not found in Carriers.");
            }
